...
const Card = ({cards, clearCard, children}) => {
    let quantity = 0;
    let totalPrice = 0;
    let shipping = 0;
    let tax = 0;
    ...
    return (
        <div className="flex flex-col gap-3 mt-[50px]">
            ...
            <span className='text-[#2A414F]'>Total Price: ${totalPrice}</span>
            <span className='text-[#2A414F]'>Total Shipping Charge: ${shipping}</span>
